...
namespace MahApps.RESTBase
{
    public interface IRestClientBase
    {
        ...
        void BeginRequest(string path, IDictionary<string, string> parameters, IDictionary<string, File> files, WebMethod method, RestCallback callback, object userState);
    }
}